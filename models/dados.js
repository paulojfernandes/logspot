...
exports.dashboard = function (req, res) {
    ...
    connection.query('select count(l_atividade.id_atividade) as total, ls_tipo_atividade.tipo_atividade from ls_tipo_atividade,l_atividade where l_atividade.id_tipo_atividade= ls_tipo_atividade.id_tipo_atividade and ls_tipo_atividade.id_tipo_atividade= 3 ', function (err, rows, fields) {
        if (!err) {
            console.log("entrei");
    ...
    connection.query('select count(l_atividade.id_atividade) as total, ls_tipo_atividade.tipo_atividade from ls_tipo_atividade,l_atividade where l_atividade.id_tipo_atividade= ls_tipo_atividade.id_tipo_atividade and ls_tipo_atividade.id_tipo_atividade= 4 ', function (err, rows, fields) {
        if (!err) {
            console.log("entrei");
    ...
    connection.query('select count(l_atividade.id_atividade) as total, ls_tipo_atividade.tipo_atividade from ls_tipo_atividade,l_atividade where l_atividade.id_tipo_atividade= ls_tipo_atividade.id_tipo_atividade and ls_tipo_atividade.id_tipo_atividade= 5 ', function (err, rows, fields) {
        if (!err) {
            console.log("entrei");
